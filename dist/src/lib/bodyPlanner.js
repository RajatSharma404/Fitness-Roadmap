...
exports.calculateBodyPlan = calculateBodyPlan;
...
const goalCalorieFactor = {
    fat_loss: 0.8,
    weight_loss: 0.85,
    muscle_gain: 1.1,
    recomposition: 0.92,
};
const goalProteinPerKg = {
    fat_loss: 2.0,
    weight_loss: 1.8,
    muscle_gain: 2.2,
    recomposition: 2.0,
...
function buildWorkoutPlan(goal, workoutDays) {
    ...
    for (let index = 0; index < 7; index += 1) {
        ...
        if (goal === "muscle_gain") {
            plan.push({
                ...
                durationMin: 65,
                targetSteps: 7500,
                prescription: "4 compound lifts, 3-4 sets each, 6-12 reps, finish with core work.",
            });
            continue;
        }
        if (goal === "recomposition") {
            plan.push({
                ...
                durationMin: 60,
                targetSteps: 9500,
                prescription: "3 strength blocks + 12 min intervals (bike/rower), 8-12 reps.",
            });
            continue;
        }
        plan.push({
            ...
            durationMin: 55,
            targetSteps: 10000,
            prescription: "Full-body circuit: squat, push, pull, hinge, carry. 3 rounds + 20 min incline walk.",
        });
    }
    return plan;
}
function buildGymProgression(goal) {
    const repScheme = goal === "muscle_gain"
        ? "4 sets x 6-10 reps"
        : goal === "recomposition"
...
function filterMealsByDiet(diet) {
    const options = [
        {
    ...
    return [
        {
            ...
            description: "Capture age, weight, height, BMI, lifestyle and current routine.",
            level: 1,
            track: "BEGINNER",
            dependencies: [],
            position: { x: 0, y: 40 },
        },
        {
            ...
            description: "Use maintenance calories and set a safe deficit/surplus based on goal.",
            level: 1,
            track: "BEGINNER",
        ...
        },
        {
            ...
            description: "Set daily protein, carbs, fats, and fiber targets per body weight.",
            level: 2,
            track: "INTERMEDIATE",
        ...
        },
        {
            ...
            description: "Daily water target and electrolyte strategy for recovery and satiety.",
            level: 2,
            track: "INTERMEDIATE",
            dependencies: ["macros"],
            position: { x: 840, y: 40 },
        },
        {
            ...
            description: "Daily workouts with volume targets aligned to fat loss and muscle retention.",
            level: 3,
            track: "ADVANCED",
            dependencies: ["macros"],
        ...
        },
        {
            ...
            description: "Build veg/non-veg meals that hit calories and protein consistently.",
            level: 3,
            track: "ADVANCED",
            dependencies: ["macros"],
        ...
        },
        {
            ...
            description: "Track weight trend, waist, sleep, and weekly adherence score.",
            level: 4,
            track: "ELITE",
        ...
        },
        {
            ...
            description: "Adjust calories, steps, and cardio when progress stalls for 2+ weeks.",
            level: 4,
            track: "ELITE",
...
function calculateBodyPlan(input) {
    ...
    let calorieAdjustmentNote = "Keep the current calories for 2 weeks and review trend weight.";
